 ...
 */
export class GoogleConnectionResolver implements IConfigurable, IReferenceable {
    /**
     ...
     */
    public async resolve(correlationId: string): Promise<GoogleConnectionParams> {
    ...
    private composeConnection(connection: GoogleConnectionParams): GoogleConnectionParams {
        connection = GoogleConnectionParams.mergeConfigs(connection);
