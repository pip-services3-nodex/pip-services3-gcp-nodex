...
import { IGoogleFunctionService } from '../services/IGoogleFunctionService';
 ...
 */
export abstract class GoogleFunction extends Container {
    /**
    ...
    protected registerServices(): void {
        ...
        let services = this._references.getOptional<IGoogleFunctionService>(
            new Descriptor("*", "service", "google-function", "*", "*")
        );
        let cmdServices = this._references.getOptional<IGoogleFunctionService>(
            new Descriptor("*", "service", "commandable-google-function", "*", "*")
        );
    ...
    protected getCorrelationId(req: any): string {
        return GoogleFunctionRequestHelper.getCorrelationId(req);
    }
    ...
    protected getCommand(req: Request): string {
        return GoogleFunctionRequestHelper.getCommand(req);
    }
