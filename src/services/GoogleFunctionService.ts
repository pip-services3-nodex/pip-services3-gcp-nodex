...
import { IGoogleFunctionService } from './IGoogleFunctionService';
import { GoogleFunctionRequestHelper } from '../containers/GoogleFunctionRequestHelper';

/**
 * Abstract service that receives remove calls via Google Function protocol.
 * 
 * This service is intended to work inside GoogleFunction container that
 ...
 *     service.open("123");
 */
export abstract class GoogleFunctionService implements IGoogleFunctionService, IOpenable, IConfigurable,
    IReferenceable {

    private _name: string;
    private _actions: GoogleFunctionAction[] = [];
     ...
     */
    public getActions(): GoogleFunctionAction[] {
    ...
    protected registerAction(name: string, schema: Schema, action: (req: Request, res: Response) => Promise<any>): void {
        ...
        let self = this;
        let registeredAction: GoogleFunctionAction = {
