...
import { GoogleConnectionParams } from '../connect/GoogleConnectionParams';
import { GoogleConnectionResolver } from '../connect/GoogleConnectionResolver';
 ...
 */
export abstract class GoogleFunctionClient implements IOpenable, IConfigurable, IReferenceable {
    /**
     * The HTTP client.
     */
     ...
     */
    protected _connection: GoogleConnectionParams;
     ...
     */
    protected _connectionResolver: GoogleConnectionResolver = new GoogleConnectionResolver();
    /**
     * The logger.
     */
