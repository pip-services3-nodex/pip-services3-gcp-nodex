...
exports.DummyGoogleFunction = void 0;
...
class DummyGoogleFunction extends GoogleFunction_1.GoogleFunction {
    ...
    getPageByFilter(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            let params = req.body;
            let page = this._controller.getPageByFilter(params.correlation_id, new pip_services3_commons_nodex_2.FilterParams(params.filter), new pip_services3_commons_nodex_3.PagingParams(params.paging));
