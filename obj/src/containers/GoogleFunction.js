...
const GoogleFunctionRequestHelper_1 = require("./GoogleFunctionRequestHelper");
/**
 ...
 */
class GoogleFunction extends pip_services3_container_nodex_1.Container {
    /**
     ...
     *
     * Note: Overloading of this method has been deprecated. Use GoogleFunctionService instead.
     */
    register() { }
    /**
    ...
    registerServices() {
        ...
        let services = this._references.getOptional(new pip_services3_commons_nodex_4.Descriptor("*", "service", "google-function", "*", "*"));
        let cmdServices = this._references.getOptional(new pip_services3_commons_nodex_4.Descriptor("*", "service", "commandable-google-function", "*", "*"));
    ...
    getCorrelationId(req) {
        return GoogleFunctionRequestHelper_1.GoogleFunctionRequestHelper.getCorrelationId(req);
    }
    /**
     ...
     */
    getCommand(req) {
        return GoogleFunctionRequestHelper_1.GoogleFunctionRequestHelper.getCommand(req);
    }
    /**
...
exports.GoogleFunction = GoogleFunction;
//# sourceMappingURL=GoogleFunction.js.map