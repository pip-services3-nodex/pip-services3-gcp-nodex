 ...
 */
export declare abstract class GoogleFunctionClient implements IOpenable, IConfigurable, IReferenceable {
    /**
     * The HTTP client.
     */
     ...
     */
    protected _connectionResolver: GoogleConnectionResolver;
    /**
     * The logger.
     */
